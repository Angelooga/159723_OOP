...
public class Juego {
	...
	public int iniciarJuego()  {
		...
		int[] pokeClases = {0,1,2,0,1,2,0,1,2,0,1,2,0,1,2};
		ArrayMan randomPokemon = new ArrayMan(pokeClases);
		...
		pokeClases = randomPokemon.shuffleList();
		...
		//System.out.println(pokemonAdivinar);
